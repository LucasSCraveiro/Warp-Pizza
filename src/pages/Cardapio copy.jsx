...
function Cardapio()
{
    ...
    function colocarPizzas()
    {
        var localPizza = [];
        for (let contador = 0; contador <= 2; contador++)
        {
            localPizza.push(
                <div className="w-4/12 drop-shadow-md px-2" key={pizzas2[contador].cd_pizza}>
                    <div className="w-full pb-3 px-3 bg-white rounded-lg h-[15rem]">
                        <div className="flex py-2 justify-start">
                            <div className="w-7/12 text-left pe-5">
                                <p className="font-medium text-lg reticencias">{pizzas2[contador].nm_pizza}</p>
                                <p className="font-base text-sm mb-5 reticencias h-[3.8rem]">{pizzas2[contador].ds_pizza}</p>
                                <p className="text-sm">A partir de</p>
                                <p className="font-medium">{pizzas2[contador].vl_pizza} Créditos</p>
                            </div>
                            <div className="w-5/12 flex justify-center items-center">
                                <div className=" border border-gray-400 rounded-lg flex justify-center items-center imagemCardPizza shadow-inner h-[9rem]">
                                    <img src={pizzas2[contador].img_pizza} className=""></img>
                                </div>
                            </div>
                        </div>
